...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("CopiedSizeDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class CopiedSizeDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As CopiedSizeDataSet = CType(MyBase.Clone,CopiedSizeDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "CopiedSizeDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/CopiedSizeDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As CopiedSizeDataSet = New CopiedSizeDataSet()
    ...
    Partial Public Class OrderSizeDetailsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddOrderSizeDetailsRow(ByVal OrderDetailsId As Long, ByVal SizeId As Long, ByVal OrderQuantity As Decimal, ByVal PackType As String) As OrderSizeDetailsRow
            Dim rowOrderSizeDetailsRow As OrderSizeDetailsRow = CType(Me.NewRow,OrderSizeDetailsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, OrderDetailsId, SizeId, OrderQuantity, PackType}
    ...
    Partial Public Class OrderSizeDetailsRow
        ...
        Public Property OrderQuantity() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableOrderSizeDetails.OrderQuantityColumn),Decimal)
                Catch e As Global.System.InvalidCastException
...
Namespace CopiedSizeDataSetTableAdapters
    ...
    Partial Public Class OrderSizeDetailsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [OrderSizeDetails] WHERE (([SizeDetailsId] = @Original_SizeDetailsId)"& _ 
                ...
                "ntity] IS NULL) OR ([OrderQuantity] = @Original_OrderQuantity)) AND ((@IsNull_Pa"& _ 
                "ckType = 1 AND [PackType] IS NULL) OR ([PackType] = @Original_PackType)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [OrderSizeDetails] ([OrderDetailsId], [SizeId], [OrderQuantity], [Pac"& _ 
                "kType]) VALUES (@OrderDetailsId, @SizeId, @OrderQuantity, @PackType);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Si"& _ 
                "zeDetailsId, OrderDetailsId, SizeId, OrderQuantity, PackType FROM OrderSizeDetai"& _ 
                "ls WHERE (SizeDetailsId = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [OrderSizeDetails] SET [OrderDetailsId] = @OrderDetailsId, [SizeId] = @Siz"& _ 
                "eId, [OrderQuantity] = @OrderQuantity, [PackType] = @PackType WHERE (([SizeDetai"& _ 
                "lsId] = @Original_SizeDetailsId) AND ((@IsNull_OrderDetailsId = 1 AND [OrderDeta"& _ 
                "ilsId] IS NULL) OR ([OrderDetailsId] = @Original_OrderDetailsId)) AND ((@IsNull_"& _ 
                "SizeId = 1 AND [SizeId] IS NULL) OR ([SizeId] = @Original_SizeId)) AND ((@IsNull"& _ 
                "_OrderQuantity = 1 AND [OrderQuantity] IS NULL) OR ([OrderQuantity] = @Original_"& _ 
                "OrderQuantity)) AND ((@IsNull_PackType = 1 AND [PackType] IS NULL) OR ([PackType"& _ 
                "] = @Original_PackType)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SizeDetailsId, OrderDetailsId, SizeId, OrderQ"& _ 
                "uantity, PackType FROM OrderSizeDetails WHERE (SizeDetailsId = @SizeDetailsId)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     SizeDetailsId, OrderDetailsId, SizeId, OrderQuantity, PackType"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM  "& _ 
                "       OrderSizeDetails"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (OrderDetailsId = @OrderDetailsId)"
        ...
        Public Overloads Overridable Function FillSizeByOrderDetailsId(ByVal dataTable As CopiedSizeDataSet.OrderSizeDetailsDataTable, ByVal OrderDetailsId As Global.System.Nullable(Of Long)) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal OrderDetailsId As Global.System.Nullable(Of Long)) As CopiedSizeDataSet.OrderSizeDetailsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (OrderDetailsId.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(OrderDetailsId.Value,Long)
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            End If
            Dim dataTable As CopiedSizeDataSet.OrderSizeDetailsDataTable = New CopiedSizeDataSet.OrderSizeDetailsDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As CopiedSizeDataSet.OrderSizeDetailsDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As CopiedSizeDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_SizeDetailsId As Long, ByVal Original_OrderDetailsId As Global.System.Nullable(Of Long), ByVal Original_SizeId As Global.System.Nullable(Of Long), ByVal Original_OrderQuantity As Global.System.Nullable(Of Decimal), ByVal Original_PackType As String) As Integer
            ...
            If (Original_OrderQuantity.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_OrderQuantity.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal OrderDetailsId As Global.System.Nullable(Of Long), ByVal SizeId As Global.System.Nullable(Of Long), ByVal OrderQuantity As Global.System.Nullable(Of Decimal), ByVal PackType As String) As Integer
            If (OrderDetailsId.HasValue = true) Then
            ...
            If (OrderQuantity.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(OrderQuantity.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal OrderDetailsId As Global.System.Nullable(Of Long), ByVal SizeId As Global.System.Nullable(Of Long), ByVal OrderQuantity As Global.System.Nullable(Of Decimal), ByVal PackType As String, ByVal Original_SizeDetailsId As Long, ByVal Original_OrderDetailsId As Global.System.Nullable(Of Long), ByVal Original_SizeId As Global.System.Nullable(Of Long), ByVal Original_OrderQuantity As Global.System.Nullable(Of Decimal), ByVal Original_PackType As String, ByVal SizeDetailsId As Long) As Integer
            If (OrderDetailsId.HasValue = true) Then
            ...
            End If
            If (OrderQuantity.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(OrderQuantity.Value,Decimal)
            Else
            ...
            If (Original_OrderQuantity.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_OrderQuantity.Value,Decimal)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_PackType,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal OrderDetailsId As Global.System.Nullable(Of Long), ByVal SizeId As Global.System.Nullable(Of Long), ByVal OrderQuantity As Global.System.Nullable(Of Decimal), ByVal PackType As String, ByVal Original_SizeDetailsId As Long, ByVal Original_OrderDetailsId As Global.System.Nullable(Of Long), ByVal Original_SizeId As Global.System.Nullable(Of Long), ByVal Original_OrderQuantity As Global.System.Nullable(Of Decimal), ByVal Original_PackType As String) As Integer
            Return Me.Update(OrderDetailsId, SizeId, OrderQuantity, PackType, Original_SizeDetailsId, Original_OrderDetailsId, Original_SizeId, Original_OrderQuantity, Original_PackType, Original_SizeDetailsId)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As CopiedSizeDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As CopiedSizeDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._orderSizeDetailsTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As CopiedSizeDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._orderSizeDetailsTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As CopiedSizeDataSet) As Integer
