...
Partial Public Class ProgramFullAndFinalDataSet
    ...
    Partial Public Class OrderDetailsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddOrderDetailsRow(ByVal OrderId As Long, ByVal PO As String, ByVal FabricColorId As Long, ByVal EX As Date, ByVal IsClose As Boolean) As OrderDetailsRow
            Dim rowOrderDetailsRow As OrderDetailsRow = CType(Me.NewRow,OrderDetailsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, OrderId, PO, FabricColorId, EX, IsClose}
...
Namespace ProgramFullAndFinalDataSetTableAdapters
    ...
    Partial Public Class OrderDetailsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [OrderDetails] ([OrderId], [PO], [FabricColorId], [EX], [IsClose]) VA"& _ 
                "LUES (@OrderId, @PO, @FabricColorId, @EX, @IsClose);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT OrderDetailsId, Ord"& _ 
                "erId, PO, FabricColorId, EX, IsClose FROM OrderDetails WHERE (OrderDetailsId = S"& _ 
                "COPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [OrderDetails] SET [OrderId] = @OrderId, [PO] = @PO, [FabricColorId] = @Fa"& _ 
                "bricColorId, [EX] = @EX, [IsClose] = @IsClose WHERE (([OrderDetailsId] = @Origin"& _ 
                ...
                "AND [IsClose] IS NULL) OR ([IsClose] = @Original_IsClose)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT OrderDetail"& _ 
                "sId, OrderId, PO, FabricColorId, EX, IsClose FROM OrderDetails WHERE (OrderDetai"& _ 
                "lsId = @OrderDetailsId)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        OrderDetailsId, OrderId, PO, FabricColorId, EX, IsClose"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM      "& _ 
        ...
        Public Overloads Overridable Function GetData(ByVal OrderId As Long) As ProgramFullAndFinalDataSet.OrderDetailsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(OrderId,Long)
            Dim dataTable As ProgramFullAndFinalDataSet.OrderDetailsDataTable = New ProgramFullAndFinalDataSet.OrderDetailsDataTable()
        ...
        Public Overloads Overridable Function Delete(ByVal Original_OrderDetailsId As Long, ByVal Original_OrderId As Long, ByVal Original_PO As String, ByVal Original_FabricColorId As Global.System.Nullable(Of Long), ByVal Original_EX As Global.System.Nullable(Of Date), ByVal Original_IsClose As Global.System.Nullable(Of Boolean)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal OrderId As Long, ByVal PO As String, ByVal FabricColorId As Global.System.Nullable(Of Long), ByVal EX As Global.System.Nullable(Of Date), ByVal IsClose As Global.System.Nullable(Of Boolean)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal OrderId As Long, ByVal PO As String, ByVal FabricColorId As Global.System.Nullable(Of Long), ByVal EX As Global.System.Nullable(Of Date), ByVal IsClose As Global.System.Nullable(Of Boolean), ByVal Original_OrderDetailsId As Long, ByVal Original_OrderId As Long, ByVal Original_PO As String, ByVal Original_FabricColorId As Global.System.Nullable(Of Long), ByVal Original_EX As Global.System.Nullable(Of Date), ByVal Original_IsClose As Global.System.Nullable(Of Boolean), ByVal OrderDetailsId As Long) As Integer
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_OrderDetailsId,Long)
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_OrderId,Long)
            If (Original_PO Is Nothing) Then
            ...
            If (Original_EX.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_EX.Value,Date)
            Else
            ...
            If (Original_IsClose.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_IsClose.Value,Boolean)
            Else
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(14).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(15).Value = CType(OrderDetailsId,Long)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal OrderId As Long, ByVal PO As String, ByVal FabricColorId As Global.System.Nullable(Of Long), ByVal EX As Global.System.Nullable(Of Date), ByVal IsClose As Global.System.Nullable(Of Boolean), ByVal Original_OrderDetailsId As Long, ByVal Original_OrderId As Long, ByVal Original_PO As String, ByVal Original_FabricColorId As Global.System.Nullable(Of Long), ByVal Original_EX As Global.System.Nullable(Of Date), ByVal Original_IsClose As Global.System.Nullable(Of Boolean)) As Integer
            Return Me.Update(OrderId, PO, FabricColorId, EX, IsClose, Original_OrderDetailsId, Original_OrderId, Original_PO, Original_FabricColorId, Original_EX, Original_IsClose, Original_OrderDetailsId)
        End Function
    End Class
