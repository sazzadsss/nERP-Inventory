...
Partial Public Class UserDataSet
    ...
    Partial Public Class UserDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddUserRow(ByVal USER_NAME As String, ByVal PASSWORD As String, ByVal USER_LEVEL As Integer, ByVal ACTIVE As Boolean, ByVal DepartmentId As Long) As UserRow
            Dim rowUserRow As UserRow = CType(Me.NewRow,UserRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, USER_NAME, PASSWORD, USER_LEVEL, ACTIVE, DepartmentId}
    ...
    Partial Public Class UserTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [User] ([USER_NAME], [PASSWORD], [USER_LEVEL], [ACTIVE], [DepartmentI"& _ 
                "d]) VALUES (@USER_NAME, @PASSWORD, @USER_LEVEL, @ACTIVE, @DepartmentId);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT"& _ 
                " USER_ID, USER_NAME, PASSWORD, USER_LEVEL, ACTIVE, DepartmentId FROM [User] WHER"& _ 
                "E (USER_ID = SCOPE_IDENTITY()) ORDER BY USER_NAME"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [User] SET [USER_NAME] = @USER_NAME, [PASSWORD] = @PASSWORD, [USER_LEVEL] "& _ 
                "= @USER_LEVEL, [ACTIVE] = @ACTIVE, [DepartmentId] = @DepartmentId WHERE (([USER_"& _ 
                "ID] = @Original_USER_ID) AND ([USER_NAME] = @Original_USER_NAME) AND ([PASSWORD]"& _ 
                " = @Original_PASSWORD) AND ([USER_LEVEL] = @Original_USER_LEVEL) AND ([ACTIVE] ="& _ 
                " @Original_ACTIVE) AND ((@IsNull_DepartmentId = 1 AND [DepartmentId] IS NULL) OR"& _ 
                " ([DepartmentId] = @Original_DepartmentId)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT USER_ID, USER_NAME, PASSWO"& _ 
                "RD, USER_LEVEL, ACTIVE, DepartmentId FROM [User] WHERE (USER_ID = @USER_ID) ORDE"& _ 
                "R BY USER_NAME"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     USER_ID, USER_NAME, PASSWORD, USER_LEVEL, ACTIVE, DepartmentId"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM  "& _ 
                "       [User]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY USER_NAME"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT     USER_ID, USER_NAME, PASSWORD, USER_LEVEL, ACTIVE, DepartmentId"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM  "& _ 
                "       [User]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (DepartmentId IN (1, 8))"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY USER_NAME"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT ACTIVE, DepartmentId, PASSWORD, USER_ID, USER_LEVEL, USER_NAME FROM [User]"& _ 
                " WHERE (USER_NAME LIKE @USER + '%')"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@USER", Global.System.Data.SqlDbType.VarChar, 100, Global.System.Data.ParameterDirection.Input, 0, 0, "USER_NAME", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(3) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(3).Connection = Me.Connection
            Me._commandCollection(3).CommandText = "SELECT ACTIVE, DepartmentId, PASSWORD, USER_ID, USER_LEVEL, USER_NAME FROM [User]"& _ 
                " WHERE (USER_NAME = @User) AND (PASSWORD = @Password) AND (DepartmentId = @Depar"& _ 
                "tment)"
            Me._commandCollection(3).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(3).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@User", Global.System.Data.SqlDbType.VarChar, 100, Global.System.Data.ParameterDirection.Input, 0, 0, "USER_NAME", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(3).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Password", Global.System.Data.SqlDbType.VarChar, 100, Global.System.Data.ParameterDirection.Input, 0, 0, "PASSWORD", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(3).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Department", Global.System.Data.SqlDbType.BigInt, 8, Global.System.Data.ParameterDirection.Input, 0, 0, "DepartmentId", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(4) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(4).Connection = Me.Connection
            Me._commandCollection(4).CommandText = "SELECT ACTIVE, DepartmentId, PASSWORD, USER_ID, USER_LEVEL, USER_NAME FROM [User]"& _ 
                " WHERE (USER_LEVEL = @UserLevel) ORDER BY USER_NAME"
            Me._commandCollection(4).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(4).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@UserLevel", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "USER_LEVEL", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function FillByAdminAndMerchandiser(ByVal dataTable As UserDataSet.UserDataTable) As Integer
        ...
        Public Overloads Overridable Function GetDataByAdminAndMerchandiser() As UserDataSet.UserDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Dim dataTable As UserDataSet.UserDataTable = New UserDataSet.UserDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByUser(ByVal dataTable As UserDataSet.UserDataTable, ByVal USER As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataByUser(ByVal USER As String) As UserDataSet.UserDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            If (USER Is Nothing) Then
                Throw New Global.System.ArgumentNullException("USER")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByUserAndPassword(ByVal dataTable As UserDataSet.UserDataTable, ByVal User As String, ByVal Password As String, ByVal Department As Global.System.Nullable(Of Long)) As Integer
            ...
            If (Department.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(2).Value = CType(Department.Value,Long)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByUserLevel(ByVal dataTable As UserDataSet.UserDataTable, ByVal UserLevel As Integer) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(4)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(UserLevel,Integer)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
            Dim returnValue As Integer = Me.Adapter.Fill(dataTable)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataByUserLevel(ByVal UserLevel As Integer) As UserDataSet.UserDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(4)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(UserLevel,Integer)
            Dim dataTable As UserDataSet.UserDataTable = New UserDataSet.UserDataTable()
            Me.Adapter.Fill(dataTable)
        ...
        Public Overloads Overridable Function Delete(ByVal Original_USER_ID As Long, ByVal Original_USER_NAME As String, ByVal Original_PASSWORD As String, ByVal Original_USER_LEVEL As Integer, ByVal Original_ACTIVE As Boolean, ByVal Original_DepartmentId As Global.System.Nullable(Of Long)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal USER_NAME As String, ByVal PASSWORD As String, ByVal USER_LEVEL As Integer, ByVal ACTIVE As Boolean, ByVal DepartmentId As Global.System.Nullable(Of Long)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal USER_NAME As String, ByVal PASSWORD As String, ByVal USER_LEVEL As Integer, ByVal ACTIVE As Boolean, ByVal DepartmentId As Global.System.Nullable(Of Long), ByVal Original_USER_ID As Long, ByVal Original_USER_NAME As String, ByVal Original_PASSWORD As String, ByVal Original_USER_LEVEL As Integer, ByVal Original_ACTIVE As Boolean, ByVal Original_DepartmentId As Global.System.Nullable(Of Long), ByVal USER_ID As Long) As Integer
            If (USER_NAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("USER_NAME")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_USER_ID,Long)
            If (Original_USER_NAME Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_USER_NAME")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_USER_LEVEL,Integer)
            Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_ACTIVE,Boolean)
            If (Original_DepartmentId.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(11).Value = CType(Original_DepartmentId.Value,Long)
            Else
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(11).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(12).Value = CType(USER_ID,Long)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal USER_NAME As String, ByVal PASSWORD As String, ByVal USER_LEVEL As Integer, ByVal ACTIVE As Boolean, ByVal DepartmentId As Global.System.Nullable(Of Long), ByVal Original_USER_ID As Long, ByVal Original_USER_NAME As String, ByVal Original_PASSWORD As String, ByVal Original_USER_LEVEL As Integer, ByVal Original_ACTIVE As Boolean, ByVal Original_DepartmentId As Global.System.Nullable(Of Long)) As Integer
            Return Me.Update(USER_NAME, PASSWORD, USER_LEVEL, ACTIVE, DepartmentId, Original_USER_ID, Original_USER_NAME, Original_PASSWORD, Original_USER_LEVEL, Original_ACTIVE, Original_DepartmentId, Original_USER_ID)
        End Function
    End Class
