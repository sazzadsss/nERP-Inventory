...
Partial Public Class CompanyDataSet
    ...
    Partial Public Class CompanyDataTable
        ...
        Private columnWeeklyOff As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public ReadOnly Property WeeklyOffColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnWeeklyOff
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCompanyRow(ByVal CompanyCode As String, ByVal CompanyName As String, ByVal Fax As String, ByVal Website As String, ByVal ContactPerson As String, ByVal WeeklyOff As String) As CompanyRow
            Dim rowCompanyRow As CompanyRow = CType(Me.NewRow,CompanyRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, CompanyCode, CompanyName, Fax, Website, ContactPerson, WeeklyOff}
        ...
        Friend Sub InitVars()
            ...
            Me.columnWeeklyOff = MyBase.Columns("WeeklyOff")
        End Sub
        ...
        Private Sub InitClass()
            ...
            Me.columnWeeklyOff = New Global.System.Data.DataColumn("WeeklyOff", GetType(String), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnWeeklyOff)
            ...
            Me.columnWeeklyOff.AllowDBNull = false
            Me.columnWeeklyOff.MaxLength = 50
        End Sub
    ...
    Partial Public Class CompanyRow
        ...
        Public Property CompanyCode() As String
            Get
                Return CType(Me(Me.tableCompany.CompanyCodeColumn),String)
            End Get
            Set
                Me(Me.tableCompany.CompanyCodeColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Property WeeklyOff() As String
            Get
                Return CType(Me(Me.tableCompany.WeeklyOffColumn),String)
            End Get
            Set
                Me(Me.tableCompany.WeeklyOffColumn) = value
            End Set
        End Property
    End Class
...
Namespace CompanyDataSetTableAdapters
    ...
    Partial Public Class CompanyTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("WeeklyOff", "WeeklyOff")
            Me._adapter.TableMappings.Add(tableMapping)
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Company] WHERE (([CompanyId] = @Original_CompanyId) AND ([Comp"& _ 
                "anyCode] = @Original_CompanyCode) AND ([CompanyName] = @Original_CompanyName) AN"& _ 
                "D ([Fax] = @Original_Fax) AND ([Website] = @Original_Website) AND ([ContactPerso"& _ 
                "n] = @Original_ContactPerson) AND ([WeeklyOff] = @Original_WeeklyOff))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_WeeklyOff", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "WeeklyOff", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Company] ([CompanyCode], [CompanyName], [Fax], [Website], [Con"& _ 
                "tactPerson], [WeeklyOff]) VALUES (@CompanyCode, @CompanyName, @Fax, @Website, @C"& _ 
                "ontactPerson, @WeeklyOff);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CompanyId, CompanyCode, CompanyName, Fax, Web"& _ 
                "site, ContactPerson, WeeklyOff FROM Company WHERE (CompanyId = SCOPE_IDENTITY())"& _ 
                ""
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@WeeklyOff", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "WeeklyOff", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Company] SET [CompanyCode] = @CompanyCode, [CompanyName] = @Company"& _ 
                "Name, [Fax] = @Fax, [Website] = @Website, [ContactPerson] = @ContactPerson, [Wee"& _ 
                "klyOff] = @WeeklyOff WHERE (([CompanyId] = @Original_CompanyId) AND ([CompanyCod"& _ 
                "e] = @Original_CompanyCode) AND ([CompanyName] = @Original_CompanyName) AND ([Fa"& _ 
                "x] = @Original_Fax) AND ([Website] = @Original_Website) AND ([ContactPerson] = @"& _ 
                "Original_ContactPerson) AND ([WeeklyOff] = @Original_WeeklyOff));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Compan"& _ 
                "yId, CompanyCode, CompanyName, Fax, Website, ContactPerson, WeeklyOff FROM Compa"& _ 
                "ny WHERE (CompanyId = @CompanyId)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@WeeklyOff", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "WeeklyOff", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_WeeklyOff", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "WeeklyOff", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CompanyId, CompanyCode, CompanyName, Fax, Website, ContactPerson, WeeklyOf"& _ 
                "f FROM dbo.Company"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CompanyId As Long, ByVal Original_CompanyCode As String, ByVal Original_CompanyName As String, ByVal Original_Fax As String, ByVal Original_Website As String, ByVal Original_ContactPerson As String, ByVal Original_WeeklyOff As String) As Integer
            ...
            Else
                Me.Adapter.DeleteCommand.Parameters(3).Value = CType(Original_Fax,String)
            End If
            ...
            Else
                Me.Adapter.DeleteCommand.Parameters(5).Value = CType(Original_ContactPerson,String)
            End If
            If (Original_WeeklyOff Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_WeeklyOff")
            Else
                Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_WeeklyOff,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal CompanyCode As String, ByVal CompanyName As String, ByVal Fax As String, ByVal Website As String, ByVal ContactPerson As String, ByVal WeeklyOff As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(Fax,String)
            End If
            ...
            End If
            If (WeeklyOff Is Nothing) Then
                Throw New Global.System.ArgumentNullException("WeeklyOff")
            Else
                Me.Adapter.InsertCommand.Parameters(5).Value = CType(WeeklyOff,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal CompanyCode As String, ByVal CompanyName As String, ByVal Fax As String, ByVal Website As String, ByVal ContactPerson As String, ByVal WeeklyOff As String, ByVal Original_CompanyId As Long, ByVal Original_CompanyCode As String, ByVal Original_CompanyName As String, ByVal Original_Fax As String, ByVal Original_Website As String, ByVal Original_ContactPerson As String, ByVal Original_WeeklyOff As String, ByVal CompanyId As Long) As Integer
            If (CompanyCode Is Nothing) Then
                Throw New Global.System.ArgumentNullException("CompanyCode")
            Else
            ...
            If (Fax Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Fax")
            Else
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(Fax,String)
            End If
            If (Website Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Website")
            Else
            ...
            If (ContactPerson Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ContactPerson")
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(ContactPerson,String)
            End If
            If (WeeklyOff Is Nothing) Then
                Throw New Global.System.ArgumentNullException("WeeklyOff")
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(WeeklyOff,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_CompanyId,Long)
            If (Original_CompanyCode Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_CompanyCode")
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_CompanyCode,String)
            End If
            If (Original_CompanyName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_CompanyName")
            Else
            ...
            If (Original_Fax Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Fax")
            Else
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_Fax,String)
            End If
            If (Original_Website Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Website")
            Else
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_Website,String)
            End If
            If (Original_ContactPerson Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_ContactPerson")
            Else
            ...
            If (Original_WeeklyOff Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_WeeklyOff")
            Else
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_WeeklyOff,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(13).Value = CType(CompanyId,Long)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CompanyCode As String, ByVal CompanyName As String, ByVal Fax As String, ByVal Website As String, ByVal ContactPerson As String, ByVal WeeklyOff As String, ByVal Original_CompanyId As Long, ByVal Original_CompanyCode As String, ByVal Original_CompanyName As String, ByVal Original_Fax As String, ByVal Original_Website As String, ByVal Original_ContactPerson As String, ByVal Original_WeeklyOff As String) As Integer
            Return Me.Update(CompanyCode, CompanyName, Fax, Website, ContactPerson, WeeklyOff, Original_CompanyId, Original_CompanyCode, Original_CompanyName, Original_Fax, Original_Website, Original_ContactPerson, Original_WeeklyOff, Original_CompanyId)
        End Function
    End Class
