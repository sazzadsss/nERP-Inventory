...
Public Class YarnStockRepot
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.YarnStockRepot.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnStockRepot
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnStockRepot = New YarnStockRepot()
        rpt.Site = Me.Site
        Return rpt
    End Function
