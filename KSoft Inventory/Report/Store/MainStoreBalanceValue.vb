...
Public Class MainStoreBalanceValue
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MainStoreBalanceValue.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.MainStoreBalanceValue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMainStoreBalanceValue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MainStoreBalanceValue = New MainStoreBalanceValue()
        rpt.Site = Me.Site
        Return rpt
    End Function
