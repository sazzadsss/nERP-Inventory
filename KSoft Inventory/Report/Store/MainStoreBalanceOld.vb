...
Public Class MainStoreBalanceOld
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MainStoreBalanceOld.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.MainStoreBalanceOld.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMainStoreBalanceOld
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MainStoreBalanceOld = New MainStoreBalanceOld()
        rpt.Site = Me.Site
        Return rpt
    End Function
