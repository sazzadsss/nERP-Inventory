...
Public Class GeneralGatePass
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.GeneralGatePass.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGeneralGatePass
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GeneralGatePass = New GeneralGatePass()
        rpt.Site = Me.Site
        Return rpt
    End Function
