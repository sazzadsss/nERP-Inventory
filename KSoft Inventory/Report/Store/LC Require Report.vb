...
Public Class LC_Require_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.LC Require Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLC_Require_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LC_Require_Report = New LC_Require_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
