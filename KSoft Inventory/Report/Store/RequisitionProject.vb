...
Public Class RequisitionProject
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.RequisitionProject.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRequisitionProject
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RequisitionProject = New RequisitionProject()
        rpt.Site = Me.Site
        Return rpt
    End Function
