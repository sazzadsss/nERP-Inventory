...
Public Class RequisitionDyeing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.RequisitionDyeing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRequisitionDyeing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RequisitionDyeing = New RequisitionDyeing()
        rpt.Site = Me.Site
        Return rpt
    End Function
