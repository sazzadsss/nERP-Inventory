...
Public Class CHEMICAL_LIST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.CHEMICAL LIST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCHEMICAL_LIST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CHEMICAL_LIST = New CHEMICAL_LIST()
        rpt.Site = Me.Site
        Return rpt
    End Function
