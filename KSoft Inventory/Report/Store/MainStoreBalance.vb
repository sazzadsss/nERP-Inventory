...
Public Class MainStoreBalance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.MainStoreBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMainStoreBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MainStoreBalance = New MainStoreBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
