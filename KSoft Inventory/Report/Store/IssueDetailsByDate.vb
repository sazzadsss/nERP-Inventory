...
Public Class IssueDetailsByDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.IssueDetailsByDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIssueDetailsByDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IssueDetailsByDate = New IssueDetailsByDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
