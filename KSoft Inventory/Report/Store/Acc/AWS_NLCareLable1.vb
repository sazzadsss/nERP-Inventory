...
Public Class AWS_NLCareLable1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.AWS_NLCareLable1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAWS_NLCareLable1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AWS_NLCareLable1 = New AWS_NLCareLable1()
        rpt.Site = Me.Site
        Return rpt
    End Function
