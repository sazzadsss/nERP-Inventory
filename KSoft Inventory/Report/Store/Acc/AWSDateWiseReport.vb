...
Public Class AWSDateWiseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.AWSDateWiseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAWSDateWiseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AWSDateWiseReport = New AWSDateWiseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
