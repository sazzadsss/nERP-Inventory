...
Public Class AWSSupplierWise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.AWSSupplierWise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAWSSupplierWise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AWSSupplierWise = New AWSSupplierWise()
        rpt.Site = Me.Site
        Return rpt
    End Function
