...
Public Class RequisitionAzad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.RequisitionAzad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRequisitionAzad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RequisitionAzad = New RequisitionAzad()
        rpt.Site = Me.Site
        Return rpt
    End Function
