...
Public Class YarnDyeingReceiveIssue
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "YarnDyeingReceiveIssue.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.YarnDyeingReceiveIssue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnDyeingReceiveIssue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnDyeingReceiveIssue = New YarnDyeingReceiveIssue()
        rpt.Site = Me.Site
        Return rpt
    End Function
