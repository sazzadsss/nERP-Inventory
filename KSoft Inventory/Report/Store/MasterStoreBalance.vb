...
Public Class MasterStoreBalance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.MasterStoreBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMasterStoreBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MasterStoreBalance = New MasterStoreBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
