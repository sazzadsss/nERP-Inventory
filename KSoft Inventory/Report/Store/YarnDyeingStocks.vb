...
Public Class YarnDyeingStocks
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.YarnDyeingStocks.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedYarnDyeingStocks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As YarnDyeingStocks = New YarnDyeingStocks()
        rpt.Site = Me.Site
        Return rpt
    End Function
