...
Public Class StoreBalanceReportNew
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StoreBalanceReportNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KSoft_Inventory.StoreBalanceReportNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStoreBalanceReportNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StoreBalanceReportNew = New StoreBalanceReportNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
